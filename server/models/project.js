...
const projectSchema = mongoose.Schema(
  {
    ...
    ocurrence: {
      type: [String],
      required: [true, "Project Timing is Required!"],
    },
    ...
    tasks: { type: String, required: [true, "asks is Required!"] },
...
projectSchema.statics.changeProjectStatusBasedOnDecision = async function (
  projectId,
  decision
) {
  try {
