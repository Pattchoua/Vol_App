...
const createProject = async (req, res) => {
  try {
    ...
    console.log(
      "🚀 ~ file: projects.js:11 ~ createProject ~ project:",
      project
    );
...
const getProjects = async (req, res) => {
  try {
    ...
    console.log(
      "🚀 ~ file: projects.js:33 ~ getProjects ~ projects:",
      projects
    );
...
console.log(
  "🚀 ~ file: projects.js:40 ~ getProjects ~ getProjects:",
  getProjects
);
...
const getProjectDetails = async (req, res) => {
  try {
    ...
    console.log(
      "🚀 ~ file: projects.js:46 ~ getProjectById ~ project:",
      project
    );
    if (!project) {
...
const applyForProject = async (req, res) => {
  try {
    ...
    const volunteerAlreadyApplied = project.volunteers.some((volunteer) =>
      volunteer._id.equals(req.volunteer._id)
    );

    if (volunteerAlreadyApplied) {
      return res
        .status(400)
        .json({ Error: "Volunteer has already applied for this project" });
    }
...
const deleteProject = async (req, res) => {
  try {
    ...
    console.log(
      "🚀 ~ file: projects.js:91 ~ deletePost ~ deletedProject:",
      deletedProject
    );
    if (!deletedProject) {
