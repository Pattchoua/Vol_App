...
const register = async (req, res) => {
  ...
  try {
    ...
    console.log(
      "🚀 ~ file: auth-organization.js:11 ~ register ~ newOrganization:",
      newOrganization
    );
    const organization = {
...
const login = async (req, res) => {
  ...
  try {
    ...
    if (!currentOrganization) {
      ...
      console.log(
        "🚀 ~ file: auth-organization.js:41 ~ login ~ currentOrganization:",
...
const getLoggedinOrganization = async (req, res) => {
  ...
  console.log(
    "🚀 ~ file: auth-organization.js:90 getLoggedinOrganization ~  req:",
    req.organization
  );
  try {
    const organization = await Organization.findOne({
      _id: req.organization._id,
    }).select("_id email organizationName");
    console.log(
